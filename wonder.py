...
if page == "Home":
    ...
    st.subheader("📌 Guide Template Example")
    st.markdown("""
### Title: Exploring the Charms of [City Name]

**Introduction:**
Welcome to [City Name], a city known for...
...
**Final Thoughts:**
Wrap up with suggestions and reflections.
    """)
...
if page == "Generate Guide":
    ...
    summary = st.text_area("Optional Summary or Notes")
    if st.button("Generate Guide") and city:
        with st.spinner("Generating guide..."):
            ...
            try:
                ...
                st.session_state.last_guide = {"city": city, "guide": guide}
                st.text_area("Your Travel Guide", guide, height=300)

                if st.button("Add to Book"):
                    st.session_state.book.append(st.session_state.last_guide)
    ...
    if st.button("Generate Surprise Guide"):
        with st.spinner("Generating guide..."):
            ...
            try:
                ...
                guide = response.choices[0].message.content
                st.session_state.last_guide = {"city": random_city, "guide": guide}
